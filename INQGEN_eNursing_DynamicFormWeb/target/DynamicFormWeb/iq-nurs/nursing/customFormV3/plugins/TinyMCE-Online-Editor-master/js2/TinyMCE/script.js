...
var _update_preview_window = function () {
    ...
    _preview_window.document.body.innerHTML = $("#file_content").val().trim()||$("#file_content").val();
...
var _startup = function () {
    ...
    init_tinymce();
    // console.log("=========this");
    // console.log(parent["textareaEditor_setDefaultValue_"+this.name]());
    // console.log(parent.$("#"+this.name)[0].contentWindow.tinymce.get("file_content"));
    // $("#file_content").val(parent["textareaEditor_setDefaultValue_"+this.name]()).change();
    parent["textareaEditor_setDefaultValue_"+this.name]();
};

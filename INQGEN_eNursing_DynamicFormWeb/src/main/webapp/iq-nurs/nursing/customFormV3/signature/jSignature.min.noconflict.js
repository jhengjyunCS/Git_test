...
*/
    (function () {
        function t(b) {
            ...
            e ? (a = void 0, (a = e.match(b)) ? d = {
                ...
                g: parseInt(a[2], 16),
                b: parseInt(a[3], 16)
            })) : d = m ? 127 < Math.max.apply(null, [m.r, m.g, m.b]) ? {r: 0, g: 0, b: 0} : {
                r: 255,
                g: 255,
                b: 255
            } : {r: 255, g: 255, b: 255};
    ...
    (function () {
        ...
        function r(f, d) {
            var b = f.x.length - 1, a = new k(f.x[b], f.y[b]), c = new k(f.x[b - 1], f.y[b - 1]),
                a = c.getVectorToPoint(a);
            if (1 < b && a.getLength() > d) {
                var b = (new k(f.x[b - 2], f.y[b - 2])).getVectorToPoint(c), c = a.angleTo(b.reverse()),
                    e = .35 * a.getLength(), b = (new t(b.x + a.x, b.y + a.y)).resizeTo(Math.max(.05, c) * e);
        ...
        (function (f, d) {
            ...
            (typeof exports != d + "" ? exports : f).simplify = function (b, a, c) {
                ...
                f = b;
                c = f.length;
                var e = new (typeof Uint8Array != d + "" ? Uint8Array : Array)(c), g = 0, k = c - 1, p, q, r = [],
                    t = [], z = [];
                for (e[g] = e[k] = 1; k;) {
                    n = 0;
                    for (l = g + 1; l < k; l++) {
        ...
        if ("function" !== typeof D) var D = function (f) {
            var d = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".split(""), b, a, c, e, g = 0,
                k = 0, n = [];
